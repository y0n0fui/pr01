...
public class UserAdmin implements IUserAdmin{
	...
	public List<KRoles> getRoles(){
		Query query=sessionFactory.getCurrentSession().createQuery("select r from KRoles r");
	...
	public KRoles getRoles(int idRole){
		return (KRoles)sessionFactory.getCurrentSession().get(KRoles.class, idRole);
	}
	...
	public List<CTipoCargo> getTipoCargo(){
		Query query=sessionFactory.getCurrentSession().createQuery("select c from CTipoCargo c");
	...
	public CTipoCargo getTipoCargo(int idTipoCargo){
		return (CTipoCargo)sessionFactory.getCurrentSession().get(CTipoCargo.class, idTipoCargo);
	}
	...
	public List<CTipoIdentificacion> getTipoIdentificacion(){
		Query query=sessionFactory.getCurrentSession().createQuery("select c from CTipoIdentificacion c");
		List<CTipoIdentificacion> result=(List<CTipoIdentificacion>)query.list();
		return result;
	}
	...
	public CTipoIdentificacion getTipoIdentificacion(int idTipoIdentificacion){
		return (CTipoIdentificacion)sessionFactory.getCurrentSession().get(CTipoIdentificacion.class, idTipoIdentificacion);
	}
	...
	public List<KEmpresas> getEmpresas(){
		Query query=sessionFactory.getCurrentSession().createQuery("select c from KEmpresas c");
	...
	public KEmpresas getEmpresa(int idEmpresa){
		return (KEmpresas)sessionFactory.getCurrentSession().get(KEmpresas.class, idEmpresa);
	}
	...
	public List<KUsuariosEmpresas> getUsuarioEmpresas(){
		Query query=sessionFactory.getCurrentSession().createQuery("select c from KUsuariosEmpresas c");
	...
	public List<KUsuariosEmpresas> getUsuarioEmpresasByEmpresa(int empresaId){
		Query query=sessionFactory.getCurrentSession().createQuery("select c from KUsuariosEmpresas c where c.KEmpresas.id=:idEmpr");
	...
	public KUsuariosEmpresas getUsuarioEmpresas(int idUsuarioEmpresa){
		return (KUsuariosEmpresas)sessionFactory.getCurrentSession().get(KUsuariosEmpresas.class, idUsuarioEmpresa);
	}
	...
	public List<KUsuariosFunciones> getUsuariosFunciones(){
		Query query=sessionFactory.getCurrentSession().createQuery("select u from KUsuariosFunciones u");
		List<KUsuariosFunciones> result=(List<KUsuariosFunciones>)query.list();
		return result;
	}
	...
	public KUsuariosFunciones getUsuarioFunciones(int idUsuarioFunciones){
		return (KUsuariosFunciones)sessionFactory.getCurrentSession().get(KUsuariosFunciones.class, idUsuarioFunciones);
	}
